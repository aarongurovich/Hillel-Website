...
export const Footer: React.FC<FooterProps> = ({ onDonateClick }) => {
  ...
  const facebookUrl = "https://www.facebook.com/groups/hillelatttu/events";
  const instagramUrl = "https://www.instagram.com/ttuhillel/";
  const jewishHolidaysUrl = "https://www.hebcal.com/holidays/";
  const birthrightUrl = "https://www.birthrightisrael.com/";
  const internshipsUrl = "https://www.hillel.org/hillel-onward-israel-internships/";
  const hillelInternationalUrl = "https://www.hillel.org/";
  const ttuUrl = "https://www.ttu.edu/";
